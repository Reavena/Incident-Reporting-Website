...
<head>
    ...
    <title>Reports you have on</title>
    <!-- Favicon icon -->
    ...
    document.addEventListener("DOMContentLoaded", function() {
        let table = new DataTable('#yourReportsTable', {
            order: [
                [3, 'desc']
            ]
        });
            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="./all-users.php">All Users</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">All Reports You've Worked on</h4>
                                <div class="table-responsive">
                                    <table id="yourReportsTable"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Status Creation Date</th>
